...
-- Publiczny bucket na zdjęcia profilowe. Odczyt jest publiczny, ale zapis,
-- podmiana i usunięcie są dozwolone wyłącznie we własnym folderze użytkownika.
...
-- Użytkownik może usunąć wyłącznie własne konto. Powiązane rekordy znikają
-- przez ON DELETE CASCADE, a zdjęcie profilowe jest usuwane ze Storage.
