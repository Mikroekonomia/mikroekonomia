...
const storageKey = 'mankiw-taylor-study-progress-v11';
const legacyStorageKeys = ['mankiw-taylor-study-progress-v9', 'mankiw-taylor-study-progress-v7', 'mankiw-taylor-study-progress-v5'];
...
const loadProgress = () => {
  try {
    ...
    return {
      ...
      awardedFlashcards: Array.isArray(parsed.awardedFlashcards) ? parsed.awardedFlashcards : [],
      completedQuizzes: Number.isFinite(parsed.completedQuizzes) ? Math.max(0, parsed.completedQuizzes) : 0,
      completedTests: Number.isFinite(parsed.completedTests) ? Math.max(0, parsed.completedTests) : 0,
    ...
    return { mastered: [], starred: [], points: 0, awardedFlashcards: [], completedQuizzes: 0, completedTests: 0, studySeconds: 0, awardedStudyBlocks: 0 };
  }
};
...
$('#resetProgress').addEventListener('click', () => {
  ...
  progress = { mastered: [], starred: [], points: 0, awardedFlashcards: [], completedQuizzes: 0, completedTests: 0, studySeconds: 0, awardedStudyBlocks: 0 };
  saveProgress();
